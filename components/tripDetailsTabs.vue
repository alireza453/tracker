...
<template>
  <UTabs :items="details_tab_items" class="w-full" :defaultIndex="2">
    ...
    <template #item="{ item }">
      ...
      <div v-if="item.key === 'options_info'">
      ...
      <div v-if="item.key === 'trip_info'" class="space-y-3">
        ...
        <div class="flex justify-around items-center text-sm">
          ...
          >
            <span class="font-semibold"> 1:20:45 </span>

            <span class="text-emerald-500 w-4 h-4">
          ...
          <div
            class="flex items-center justify-center gap-1 dark:text-base-100"
          >
            <span class="font-semibold"> 2km </span>
            <span class="text-emerald-500 w-4 h-4">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
                  fill="currentColor"
        ...
        <!-- start -->
        <div
          class="dark:bg-gray-800 bg-base-100 p-2 border-2 rounded-lg border-gray-200 dark:border-slate-700"
        >
          <div class="flex items-center justify-end gap-2">
            <UBadge
              size="sm"
              class="text-right flex flex-col gap-1"
              variant="solid"
              color="gray"
            >
              <p>ساعت: 12:35</p>
              <p>تاریخ: 1402/11/19</p>
            </UBadge>
          ...
          <span class="text-gray-800 dark:text-base-100 block my-2 text-sm text-right"
            >آدرس: فارس، شیراز، بلوار کریمخان زند، کریمخان زند ۱۱، دانشور</span
          >
        ...
        >
          <div class="flex items-center justify-end gap-2">
            ...
            <span class="w-11 h-11 text-error">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
                  fill="currentColor"
                  d="M256 0C149.3 0 64 85.3 64 192c0 36.9 11 65.4 30.1 94.3l141.7 215c4.3 6.5 11.7 10.7 20.2 10.7s16-4.3 20.2-10.7l141.7-215C437 257.4 448 228.9 448 192C448 85.3 362.7 0 256 0m0 298.6c-58.9 0-106.7-47.8-106.7-106.8S197.1 85 256 85c58.9 0 106.7 47.8 106.7 106.8S314.9 298.6 256 298.6m0-170.6c-35.4 0-64 28.6-64 64s28.6 64 64 64s64-28.6 64-64s-28.6-64-64-64"
